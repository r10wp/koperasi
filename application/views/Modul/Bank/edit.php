    ...
    <div class="row">
      <div class="col-md-5 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?= base_url('Bank/edit/'.$prim_kode)?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="bank" value="<?=$detail1->nama_bank ?>" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-7 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="pt" value="<?=$detail1->pt_bank ?>" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" name="call" value="<?=$detail1->call_center_bank ?>" required>
                </div>
              </div>
              <?php endforeach; ?>
              ...
              <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
                  ...
                  <button type="submit" class="btn btn-info"><i class="fa fa-edit"></i> Ubah Data Bank</button>
                </div>
              </div>
            </form>
          </div>
