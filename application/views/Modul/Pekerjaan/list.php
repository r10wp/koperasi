    ...
    <div class="row">
      <div class="col-md-5 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?= base_url('Pekerjaan/add')?>">
              ...
              <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-1">
                  ...
                  <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pekerjaan Baru</button>
                </div>
              </div>
            </form>
          </div>
