  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-5 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Formulir Ubah Jenis Keperluan Pinjam</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
            <?php foreach ($cetak_detail1 as $detail): ?>
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?= base_url('Jenis_keperluan_pinjaman/edit/'.$detail->id)?>">
                <div class="form-group">
                  <label class="control-label col-xs-4" for="first-name">Jenis Keperluan <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" required="required" class="form-control" name="jenis" value="<?= $detail->jenis?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    <textarea id="message" rows="3" name="keterangan" ><?= $detail->keterangan?></textarea>
                  </div>
                </div>
                <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
                    <a href="<?= base_url('Jenis_keperluan_pinjaman')?>" class="btn btn-default">Batal</a>
                    <button type="submit" class="btn btn-warning"><i class="fa fa-edit"></i> Edit Keperluan Pinjam</button>
                  </div>
                </div>
              </form>
            <?php endforeach; ?>
