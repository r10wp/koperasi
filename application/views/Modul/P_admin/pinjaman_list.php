            ...
            <table id="datatable-sort00" class="table table-striped table-bordered" >
              ...
              <tbody>
                <?php foreach ($cetak_list1 as $list1): ?>
                  <tr>
                    <td width="10%"><?= $list1->tgl_pinjaman ?></td>
                    <td width="15%"><?= $list1->nomor_anggota ?></td>
                    ...
                    <td>
                      ...
                      <?php elseif($list1->status_pinjam == -1): ?>
                        <p style="color:orange"> Menunggu Pencarian</p>
                      <?php elseif($list1->status_pinjam == -2): ?>
                        Menunggu Konfirmasi Persetujuan Auditor
                      <?php endif; ?>
                    </td>
                    <td width="15%">
                      <?php if ($list1->status_pinjam == 1): ?>
                        ...
                        <a href="<?= base_url('P_admin/listBayar/'.$list1->kode)?>" class="btn btn-success btn-sm">
                          <i class="fa fa-list-alt"> Lihat Pembayaran</i>
                        </a>
                      <?php elseif($list1->status_pinjam == 0): ?>
                      ...
                      <?php elseif($list1->status_pinjam == -1): ?>
                        <a href="<?= base_url('P_admin/accPinjam/'.$list1->kode)?>" class="btn btn-warning btn-sm">
                          <i class="fa fa-warning"> Verifikasi dan Cairkan</i>
                        </a>
                      <?php elseif($list1->status_pinjam == -2): ?>
