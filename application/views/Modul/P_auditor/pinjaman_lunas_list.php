  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Daftar Pinjaman Yang Sudah Lunas Nasabah</h2>
            ...
            <table id="datatable-sort00" class="table table-striped table-bordered" >
              ...
              <tbody>
                <?php foreach ($cetak_list1 as $list1): ?>
                  <tr>
                    <td width="10%"><?= substr($list1->tgl_pinjaman, 0, 10) ?></td>
                    ...
                    <td width="15%">
                      <?php if ($list1->status_pinjam == 1): ?>
                        <a href="<?= base_url('P_auditor/accPinjam/'.$list1->kode)?>" class="btn btn-primary btn-sm">
                          <i class="fa fa-check-square-o"> Selesai</i>
                        </a>
                      <?php elseif($list1->status_pinjam == 0): ?>
                        <a href="<?= base_url('P_auditor/accPinjam/'.$list1->kode)?>" class="btn btn-danger btn-sm">
                          <i class="fa fa-warning"> Di Tolak</i>
                        </a>
                      <?php elseif($list1->status_pinjam == -1): ?>
                        <a href="<?= base_url('P_auditor/accPinjam/'.$list1->kode)?>" class="btn btn-warning btn-sm">
                          <i class="fa fa-warning"> Belum di Cairkan</i>
                        </a>
                      <?php elseif($list1->status_pinjam == -2): ?>
                        <a href="<?= base_url('P_auditor/accPinjam/'.$list1->kode)?>" class="btn btn-default btn-sm">
