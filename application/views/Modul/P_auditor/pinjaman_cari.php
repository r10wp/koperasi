  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-9 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Form Pencarian Pinjaman Nasabah </h2>
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?= base_url('Pengurus/simpananCari')?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                  <input name="jenis_simpanan" type="radio" value="2" checked/>&nbsp;Wajib&nbsp;&nbsp;
                  <input name="jenis_simpanan" type="radio" value="3"/>Sukarela&nbsp;&nbsp;
                  <input name="jenis_simpanan" type="radio" value="1"/>Pokok&nbsp;&nbsp;&nbsp;
                </div>
